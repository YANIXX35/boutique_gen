...
class ValidationService {
    public static function validateCategory($name, $excludeId = null) {
        $errors = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $errors = ValidationService::validateCategory($name, $category_id);
    
    // Vérifier si le nom existe déjà (pour une autre catégorie)
    if (empty($errors) && $category->nameExists($name, $category_id)) {
        $errors[] = "Une catégorie avec ce nom existe déjà";
    }
    
    if (empty($errors)) {
        if ($category->update($category_id, $name, $description)) {
    ...
    // Garder les données soumises en cas d'erreur
...
<body>
    <div class="container-fluid">
        ...
        <div class="form-container">
            ...
            <div class="info-box">
                <h6><i class="fas fa-tag me-2"></i>Informations actuelles</h6>
                <p><strong>ID :</strong> <?php echo htmlspecialchars($category_data['id']); ?></p>
                <p><strong>Produits associés :</strong> <?php echo $product_count; ?></p>
            </div>
            ...
            <form method="POST" action="">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" 
                              ...
                              name="description" 
                              rows="4"
                              placeholder="Description détaillée de la catégorie (optionnel)"><?php echo htmlspecialchars($category_data['description'] ?? ''); ?></textarea>
